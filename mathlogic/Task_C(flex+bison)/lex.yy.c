...
static const flex_int16_t yy_accept[20] =
    {   0,
        0,    0,   13,   12,   11,    8,    5,    2,    6,    7,
        9,   12,    1,    3,   11,    4,    1,   10,    0
    } ;
